...
export default function RecipientProfile() {
  ...
  const notifTypeColor: Record<string, string> = {
    request: '#C62828', accepted: '#2563EB', approved: '#16A34A', completed: '#2EC4B6', general: '#9BA3AF',
  };
      ...
      <ScrollView showsVerticalScrollIndicator={false} contentContainerStyle={{ paddingBottom: 100 }}>
        ...
        >
          ...
          <View style={styles.roleBadge}>
            <MaterialCommunityIcons name="hospital-box" size={14} color="rgba(255,255,255,0.9)" />
            <Text style={styles.roleBadgeText}>Blood Recipient</Text>
          </View>
        </LinearGradient>
        ...
        <View style={styles.content}>
          <View style={styles.infoCard}>
            {[
              ...
              { icon: 'business-outline', label: 'Hospital', value: user.hospital || user.city },
          ...
          {notifications.length === 0 ? (
            <EmptyState icon="bell-off" title="No notifications" subtitle="You'll see updates about your requests here" />
          ) : (
