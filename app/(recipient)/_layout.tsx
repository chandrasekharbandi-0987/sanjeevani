...
function ClassicTabLayout() {
  ...
  return (
    ...
    >
      ...
      <Tabs.Screen name="search" options={{ title: 'Find Blood', tabBarIcon: ({ color }) => <Ionicons name="search" size={22} color={color} /> }} />
      <Tabs.Screen name="requests" options={{ title: 'My Requests', tabBarIcon: ({ color }) => <Ionicons name="list" size={22} color={color} /> }} />
